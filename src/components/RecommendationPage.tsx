...
export function RecommendationPage() {
  ...
  const [showRandomDestination, setShowRandomDestination] = useState(false);
  ...
  const handleRandomDestination = () => {
    if (recommendations.length > 0) {
      ...
      const randomPlace = recommendations[randomIndex];
      
      // Navigate to map with the random place as destination
      navigate('/map', { 
        state: { 
          selectedPlace: {
            id: randomPlace.id,
            ...
            coordinates: {
              lat: randomPlace.location.lat,
              lng: randomPlace.location.lon
            }
          },
          userLocation
        } 
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-blue-900 overflow-hidden">
      ...
      <div className="container mx-auto px-4 py-8 max-w-6xl">
        ...
        {/* Unknown Destination Feature */}
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.5 }}
          className="mb-8 bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl overflow-hidden"
        >
          <div className="p-6 relative">
            ...
            <div className="relative z-10">
              <h2 className="text-2xl font-bold text-white mb-2">🌍 Unknown Destination 🌍</h2>
              <p className="text-white/90 mb-4">
                Feeling adventurous? Let fate decide your next journey! Click below and discover a surprise destination—somewhere exciting, unique, and completely unexpected. Where will you go next? There's only one way to find out! 🚀✨
              </p>
              ...
              <motion.button
                ...
                className="px-6 py-3 bg-white/20 hover:bg-white/30 rounded-xl text-white font-medium transition-all duration-300 flex items-center space-x-2"
              >
